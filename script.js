import { cargarRutaNaranjo } from './js/scriptRutasNaranjo.js';
import { cargarRutaNegavita } from './js/scriptRutasNegavita.js';
import { cargarRutaSabaneta } from './js/scriptRutasSabaneta.js';
import { cargarRutaUlaga } from './js/scriptRutasUlaga.js';
import { cargarRutaRosal } from './js/scriptRutasRosal.js';
    ...
    try {
      ...
      map.addLayer({
        ...
        paint: {
          ...
          "fill-color": [
            "case",
            ["==", ["get", "Descripcion"], "Sabaneta"],
            "#FF8C00", // NARANJA
            ["==", ["get", "Descripcion"], "Negavita"],
            "#FFFF00", // AMARILLO
            ["==", ["get", "Descripcion"], "Naranjo"],
            "#FF0000", // ROJO
            ["==", ["get", "Descripcion"], "Ulaga"],
            "#0000FF", // AZUL
            ["==", ["get", "Descripcion"], "Rosal"],
            "#800080", // MORADO
      ...
      map.addLayer({
        ...
        paint: {
          ...
          "line-color": [
            "case",
            ["==", ["get", "Descripcion"], "Sabaneta"],
            "#CC7000", // NARANJA OSCURO
            ["==", ["get", "Descripcion"], "Negavita"],
            "#CCCC00", // AMARILLO OSCURO
            ["==", ["get", "Descripcion"], "Naranjo"],
            "#CC0000", // ROJO OSCURO
            ["==", ["get", "Descripcion"], "Ulaga"],
            "#0000CC", // AZUL OSCURO
            ["==", ["get", "Descripcion"], "Rosal"],
            "#660066", // MORADO OSCURO
...
if (!checkWebGLSupport()) {
  ...
  try {
    ...
    map.on("load", () => {
      ...
      // Primero carga las veredas
      addGeoJSONSource();

      // Luego carga la ruta
      cargarRutaUlaga(map);
      cargarRutaNaranjo(map);
      cargarRutaNegavita(map);
      cargarRutaSabaneta(map);
      cargarRutaRosal(map);
        ...
        .setHTML(
          ...
          <div style="padding: 10px;">
            ...
            <p><strong>Información:</strong> ${
              properties.Descripcion || "No disponible"
            }</p>
          </div>
        `
        )
    ...
    document.getElementById("map-container").innerHTML =
      ...
      "<p>No se pudo inicializar el mapa: " +
      error.message +
      "</p>" +
      "</div>";
  }
